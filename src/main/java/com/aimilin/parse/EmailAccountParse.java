 ...
 */
public class EmailAccountParse extends FileParseTemplate<EmailAccount> {

	/**
	 * @fields ignoreErrorEmail 是否忽略错误的邮件地址，true忽略，false不忽略。 默认为true 及忽略错误的邮件地址
	 */
	private boolean ignoreErrorEmail = true;

	@Override
	protected EmailAccount parseLine(String lineStr, int lineNum) throws LineParseException {
	...
	/**
	 * 设置是否忽略错误的邮件地址，true忽略，false不忽略，如果设置为true则直接跳过错误的邮件地址， 否则抛出NotEmailAddressException异常
	 * @author LiuJunGuang
