...
public class XML2BeanUtils {
	private static final String xmlHead = "<?xml version='1.0' ?>" + SystemUtils.LINE_SEPARATOR;
	 ...
	 */
	public static String bean2Xml(Object obj) throws IOException, SAXException, IntrospectionException {
		if (obj == null)
	...
	public static <T> T xml2Bean(Class<T> beanClass, String xmlFile) throws IntrospectionException, IOException,
			SAXException {
